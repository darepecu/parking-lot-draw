...
class ApplicantsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create applicant" do
    assert_difference('Applicant.count') do
      post applicants_url, params: { applicant: { plate: @applicant.plate, vehicle_type: @applicant.vehicle_type } }
    end
  ...
  test "should update applicant" do
    patch applicant_url(@applicant), params: { applicant: { plate: @applicant.plate, vehicle_type: @applicant.vehicle_type } }
